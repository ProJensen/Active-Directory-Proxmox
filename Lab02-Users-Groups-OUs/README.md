...
- Open the properties of a user account, or double-click the user account
...
![User Properties](./screenshots/5_User_Properties.png)

![Select Group to User](./screenshots/5_Select_Group_To_User.png)
