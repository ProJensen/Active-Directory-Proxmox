...
|-|-|-|-|
| 01 | [Install and Configure AD DS](./Lab01-Install-AD-DS/) | Domain setup / AD DS / DNS | In Progress |
...
| 04 | [Shared Folder and NTFS Permission Configuration](./Lab04-Shared-Folder-Permissions/) | File access / permissions | Planned |
| 05 | [Group Policy Configuration](./Lab05-GPO/) | Policy management / desktop configuration | Planned |
